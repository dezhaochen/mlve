...
from sac_ae_bilayer_ssa import SacAeAgent
...
def evaluate(env, agent, video, num_episodes, L, step, testpsnr=False):
    ...
    for step in range(args.num_train_steps):
        if done:
            ...
            if step % args.eval_freq == 0:
                ...
                evaluate(env, agent, video, args.num_eval_episodes, L, step, testpsnr=args.testpsnr)
                if args.save_model:
